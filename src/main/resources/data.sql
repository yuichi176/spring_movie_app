...
INSERT INTO movie (user_name, movie_name, add_date, movie_comment, movie_eval, movie_genre)
VALUES ('user01', 'Spider man', '2022-05-10', 'good', 4, 'action');

INSERT INTO movie (user_name, movie_name, add_date, movie_comment, movie_eval,  movie_genre)
VALUES ('user01', 'Super man', '2022-05-10', 'very good', 5, 'SF');

INSERT INTO movie (user_name, movie_name, add_date, movie_comment, movie_eval,  movie_genre)
VALUES ('user01', 'Bat man', '2022-05-10', 'bad', 2, 'horror');